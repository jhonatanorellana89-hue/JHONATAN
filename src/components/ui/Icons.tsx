...
export const BalanceSheetIcon: React.FC = () => (
...
export const SparklesIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3L9.27 9.27L3 12l6.27 2.73L12 21l2.73-6.27L21 12l-6.27-2.73z"/></svg>
);
...
export const CarIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 16.94V19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2v-1a1 1 0 0 1 1-1h1.43"/><path d="M15.31 15.31 18.3 12.3a1.41 1.41 0 0 1 2 0l1.41 1.41a1.41 1.41 0 0 1 0 2L18.8 18.61"/><path d="M22 8 18 4"/><path d="M5.12 5.12 2 8"/><path d="M14 4h-4"/><path d="M10 21h4"/><circle cx="7" cy="17" r="2"/><circle cx="17" cy="17" r="2"/></svg>
);

// Dashboard & AI
export const BrainCircuitIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 5a3 3 0 1 0-5.993.142M9 8a3 3 0 1 0 5.184 2.352M14.25 10.25a3 3 0 1 0 2.563 5.39M12.5 16.5a3 3 0 1 0-5.344-1.92M4.5 12.5a3 3 0 1 0-1.011-5.385"/><path d="M19.5 12.5a3 3 0 1 0 1.258-5.51M12 5V2M9 8v1M15 12v-1M12.5 16.5v2.5M4.5 12.5H2M19.5 12.5H22"/></svg>
);
...
export const WalletIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 12V8H6a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h12v4"/><path d="M4 6v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8"/><path d="M18 12a2 2 0 0 0-2 2h4a2 2 0 0 0-2-2z"/></svg>
);
